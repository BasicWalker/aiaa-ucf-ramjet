...
MairGen(n) = InltMassFlw*SFRJDt; %AirVel(n) * InltRho(1) * PortArea(n) * SFRJDt;         % Mass of air generated (kg)
MOxdzrGen(n) = MairGen(n) * 0.2314;                                 % Mass of oxygen generated by weight % (kg)        
MdotAir(n) = InltMassFlw; %MairGen(n)/SFRJDt;                                     % Air mass flow rate (kg/s)
...
[mach, T, P, rho, area] = flowisentropic(gamma_nzlT(n), 1.6 ,'sup');
