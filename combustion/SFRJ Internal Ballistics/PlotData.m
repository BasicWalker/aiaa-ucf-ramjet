...
plot(BurnTime,F_t,BurnTime,F_d, BurnTime, Mass*gravity, BurnTime, F_net)
...
plot(BurnTime(1:index-1), InltPres_stag(1:index-1), BurnTime(1:index-1), PCreq(1:index-1), BurnTime(1:index-1), pressure_atm(1:index-1), BurnTime(1:index-1), PC_TAFT(1:index-1))
