...
% Ethan Sherlock  04/03/21  ---  2DOF Trajectory Model Update
% ---------------------------------------------------------------------- %
clear; clc; close all;
% ------------------------- Import Tables ------------------------- %
...
alpha           = 90.0;                                                     % Launch Angle (deg) - in reference to horizon
...
F_dx(1)         = F_d(1)*cosd(alpha);                                       % Drag X (N)
F_dz(1)         = F_d(1)*sind(alpha);                                       % Drag Z (N)
F_t(1)          = 0.0;                                                      % Thrust (N) 
